...
static void draw_level(lv_obj_t *canvas, const struct status_state *state) {
    ...
    init_label_dsc(&label_right_dsc, LVGL_FOREGROUND, &zelda_oracles, LV_TEXT_ALIGN_RIGHT);
...
void draw_battery_status(lv_obj_t *canvas, const struct status_state *state) {
    ...
    init_label_dsc(&label_left_dsc, LVGL_FOREGROUND, &zelda_oracles, LV_TEXT_ALIGN_LEFT);
